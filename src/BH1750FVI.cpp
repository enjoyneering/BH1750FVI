...
#elif defined (ESP32)
bool BH1750FVI::begin(int32_t sda, int32_t scl, uint32_t speed, uint32_t stretch) //int32_t SDA & SCL for Master, uint8_t SDA & SCL for Slave
{
...
bool BH1750FVI::begin(uint8_t sda, uint8_t scl, uint32_t speed)
{
  Wire.begin(sda, scl);
